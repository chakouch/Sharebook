              ...
              <?php
                //Rajout du bouton de connexion ou déconnexion en fonction de la connexion ou non de l'utilisateur 
                          if(isset($_SESSION['id'])) {
                               ...
                               echo '</ul><span class="navbar-text actions"> <a class="btn btn-light action-button" role="button" href="/profil">Vous êtes connectez : Retour Profil</a>';
                               
                      
                            } else {


                               echo '</ul><span class="navbar-text actions"> <a class="btn btn-light action-button" role="button" href="/connexion">Connectez-vous</a>';
                            }
             ?>
