               ...
               if(in_array($file_extension,$extension_autorisees_file)){
                  if(move_uploaded_file($file_tmp_name, $file_dest)){
                        ...
                        if(!empty($_FILES['miniature']) AND in_array($miniature_extension,$extension_autorisees_miniature) ){
                           ...
                           $req = $bdd->prepare('INSERT INTO documents(Titre, Nombre_Pages, Resume, Date_Parution, Chemin, Image, Date_soumission, ID_Auteur, ID_Types, ID_Editeur, ID_Collection, ID_Utilisateur, ID_Langue) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)');
            ...
            <div class="row">
               <div class="col-md-8 ml-auto mr-auto">
                  <div class="card shadow mb-3">
                    ...
                    <form action="/upload" method="POST" enctype="multipart/form-data" style="border-radius: 20px 50px 20px 50px;">
                    @csrf
